...
matchesByPuuidId :: Region -> Puuid -> IO (TypedRequest Puuids)
matchesByPuuidId region puuid = do
  request <- parseRequest $ regionToUrl region ++ "/lol/match/v5/matches/by-puuid/" ++ puuid ++ "/ids"
